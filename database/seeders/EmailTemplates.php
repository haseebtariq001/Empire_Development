...
class EmailTemplates extends Seeder
{
    ...
    public function run()
    {
        ...
        $defaultTemplate = [
            ...
            'Unit Released' => [
                'subject' => 'Unit is now available for reservation',
                'variables' => '{
                    "App Name": "app_name",
                    "Company Name": "company_name",
                    "App Url": "app_url",
                ...
                'lang' => [
                    'en' => '<p>Hello,&nbsp;<br />Welcome to {app_name}</p>
                    <p>Unit {unit_no} of project {project_name} is released and now available for reservation!</p>
                    <p>{app_url}</p>
                    <p>Thanks,<br />{app_name}</p>',
                ],
            ],
            'Agency Approved' => [
                'subject' => 'NOC and Brokerage Documents Issued',
                'variables' => '{
                ...
                'lang' => [
                    'en' => '<p>Dear {name_of_agency} </p>

                    <p>I hope this message finds you well. We are pleased to inform you that your agencys access to our CRM system has been successfully approved. This means that you can now effectively engage in selling Empire properties through our platform.</p>
                    
                    <p>Here are the credentials required for accessing the CRM:</p>
                    
                    <p>Username: {agency_email}<br>
                    Password: {agency_password}</p>
                </p>
                   
                    <p>We kindly request that you review, sign, and upload the Brokerage Agreement on the CRM. This will ensure smooth collaboration and facilitate the process of selling Empire properties through our platform.</p>
                    
                    <p>Thank you for your cooperation. We look forward to a fruitful partnership.</p>
            ...
            'Agency Request' => [
                'subject' => 'Agency Approval Request',
                'variables' => '{
                    "App Name": "app_name",
                    "App Url": "app_url",
                    "Agency Name": "agency_name",
                    "Registeration Number": "registration_no",
                    "Website": "website",
                    "Company Whatsapp": "company_whatsapp",
                    "General Manager Whatsapp": "GM_whatsapp",
                    "Marketing Director Contact Number": "marketing_director_no",
                    "Trade License Expiry": "trno_expiry",
                    "Relational Manager Name": "relational_manager",
                    "Agency Trade License Number": "agency_license_number",
                    "Trade License Expiry Date": "trno_issue_place",
                    "Agency Created By": "created_by",
                    "Bank Name": "bank_name",
                ...
                'lang' => [
                    'en' => '<p>Hello,&nbsp;<br />A new Agency is registered on the {app_name} portal. Below are the details:</p>
                    <p><b>Agency Detail</b></p>
                    
                        <p><b>Agency Name</b>: {agency_name},
                        <br/><b>Registration Number</b>: {registration_no},
                        <br/><b>Agency Website</b>: {website},
                        <br/><b>Agency Whatsapp Number</b>: {company_whatsapp},
                        <br/><b>General Manager Whatsapp</b>: {GM_whatsapp},
                        <br/><b>Marketing Director Contact Number</b>: {marketing_director_no},
                        <br/><b>Trade License Expiry</b>: {trno_expiry},
                        <br/><b>Relational Manager Name</b>: {relational_manager},
                        <br/><b>Agency Trade License Number</b>: {agency_license_number},
                        <br/><b>Trade License Expiry Date</b>: {trno_issue_place},
                        <br/><b>Agency Created By</b>: {created_by}
                        </p>
                   
                    <p><b>Bank Detail</b></p>
                   
                        <p><b>Bank Name</b>: {bank_name},
                        <br /><b>Account Holder Name</b>: {ac_name},
                        <br /><b>Branch Name</b>: {branch_name},
                        <br /><b>Branch Address</b>: {branch_address},
                        <br /><b>Currency</b>: {currency},
                        <br /><b>Swift Code</b>: {swift_code},
                        <br /><b>IBAN</b>: {iban},</p>
                    <p>Please review the profile and issue the credentials: {app_url}</p>
                    <p>Thanks,<br />{app_name}</p>
                    ',
                ],
            ],
            ...
            'Sales Offer Send' => [
                'subject' => 'Sales Offer Send',
                'variables' => '{
                    "App Name": "app_name",
                    "App Url": "app_url",
                    "client Name": "client_name",
                    "Unit Number": "unit_number",
                    "Sales Offer Number": "sales_offer_no",
                    "Sales Offer Url": "offer_url"
                  }',
                'lang' => [

                    'en' => '<p>Hi, {client_name}</p>
                    <p>Hope this email ﬁnds you well! Please see attached Sales Offer number {sales_offer_no} for unit {unit_number}.</p>
                    <p> We are excited to present you with an exclusive sales offer! Link Attached to this email, you will find all the details of the offer along with the reservation process. This is an opportunity you would not want to miss.
                    Review the sales offer document for complete details.</p>
                    <p style="text-align: center;" align="center"><span style="font-size: 18pt;"><a style="background: #6676ef; color: #ffffff; font-family: "Open Sans", Helvetica, Arial, sans-serif; font-weight: normal; line-height: 120%; margin: 0px; text-decoration: none; text-transform: none;" href="{offer_url}" target="_blank" rel="noopener"> <strong style="color: white; font-weight: bold; text: white;">Sales Offer</strong> </a></span></p>
                    <p>Feel free to reach out if you have any questions.</p>
                    <p>Thank you for your business!!</p>
                    <p>&nbsp;</p>
                    <p>Regards,</p>
        ...
        foreach ($defaultTemplate as $templateName => $templateDetails) {
            $table = EmailTemplate::where('name', $templateName)->where('module_name', 'general')->exists();
            if (!$table) {
                $emailtemplate = EmailTemplate::updateOrCreate(
                    ['name' => $templateName, 'module_name' => 'general'],
                    [
                        'from' => 'Empire Developments',
                        'created_by' => 1,
                        'workspace_id' => 0,
                    ]
                );

                foreach ($templateDetails['lang'] as $lang => $content) {
