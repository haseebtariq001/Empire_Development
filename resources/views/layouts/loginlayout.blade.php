...
<head>
    ...
    <title>@yield('page-title') | {{ !empty(company_setting('title_text',$company_id,$workspace_id)) ? company_setting('title_text',$company_id,$workspace_id) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'Empire Developments') }}</title>

    <meta name="title" content="{{ !empty(admin_setting('meta_title')) ? admin_setting('meta_title') : 'Empire Developments' }}">
    <meta name="keywords" content="{{ !empty(admin_setting('meta_keywords')) ? admin_setting('meta_keywords') : 'Empire Developments,SaaS solution,Multi-workspace' }}">
    ...
    <meta property="og:title" content="{{ !empty(admin_setting('meta_title')) ? admin_setting('meta_title') : 'Empire Developments' }}">
    ...
    <meta property="twitter:title" content="{{ !empty(admin_setting('meta_title')) ? admin_setting('meta_title') : 'Empire Developments' }}">
                    ...
                    <div class="container">
                        <div class="navbar-brand">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                ...
                                @endphp
                                <img src="{{ $logo }}{{'?'.time()}}" alt="{{ config('app.name', 'Empire Developments') }}" class="navbar-brand-img auth-navbar-brand">
                            </a>
                        </div>
