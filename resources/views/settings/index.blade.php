   ...
   <div class="col-sm-12">
      <div class="row">
            ...
            <div class="card sticky-top setting-sidebar" style="top:30px">
               <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    @if(Auth::user()->hasRole('company'))
                     ...
                     @stack('doubleentry_setting_sidebar')
                    ...
                    <a href="#agency_import_sidenav" class="list-group-item list-group-item-action">
                        {{ __('Agency Import') }}
                        <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                    </a>
         ...
         <div class="col-xl-9">
                                    ...
                                    <div class="d-flex flex-column justify-content-between align-items-center h-100">
                                        ...
                                        <div class="choose-files mt-3">
                                            <label for="logo_dark">
                                                ...
                                                <input type="file" class="form-control" name="logo_dark" id="logo_dark" data-filename="logo_dark" onchange="document.getElementById('pre_default_logo').src = window.URL.createObjectURL(this.files[0])">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-column justify-content-between align-items-center h-100">
                                        ...
                                        <div class="choose-files mt-3">
                                            <label for="logo_light">
                                                <div class=" bg-primary "> <i class="ti ti-upload px-1"></i>{{ __('Choose file here') }}</div>
                                                <input type="file" class="form-control" name="logo_light" id="logo_light" data-filename="logo_light" onchange="document.getElementById('landing_page_logo').src = window.URL.createObjectURL(this.files[0])">
                                ...
                                <div class="card-body setting-card setting-logo-box p-3">
                                    <div class="d-flex flex-column justify-content-between align-items-center h-100">
                                        ...
                                        <div class="choose-files mt-3">
                                            <label for="favicon">
                                                <div class=" bg-primary "> <i class="ti ti-upload px-1"></i>{{ __('Choose file here') }}</div>
                                                <input type="file" class="form-control" name="favicon" id="favicon" data-filename="favicon" onchange="document.getElementById('img_favicon').src = window.URL.createObjectURL(this.files[0])">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                            <div class="col-md-3 col-sm-6 col-12">
                                                ...
                                                <div class="theme-color themes-color">
                                                    ...
                                                    <a href="#!" class="{{(company_setting('color') && company_setting('color') == 'theme-11') ? 'active_color' : ''}}" data-value="theme-11" onclick="check_theme('theme-11')"></a>
                                                    <input type="radio" class="d-none" {{ company_setting('color') == 'theme-11' ? 'checked' : '' }}  name="color" value="theme-11">
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                <h6>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="choose-files mt-3">
                                                    <label for="proposal_logo">
                                                        ...
                                                        <input type="file" class="form-control" name="proposal_logo" id="proposal_logo" data-filename="proposal_logo_update" onchange="document.getElementById('blah12').src = window.URL.createObjectURL(this.files[0])">
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="choose-files mt-3">
                                                    <label for="invoice_logo">
                                                        ...
                                                        <input type="file" class="form-control" name="invoice_logo" id="invoice_logo" data-filename="invoice_logo_update" onchange="document.getElementById('blah6').src = window.URL.createObjectURL(this.files[0])">
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group mt-2 text-end">
            ...
            @stack('doubleentry_setting_sidebar_div')
                            ...
                            <div class="setting-card">
                                ...
                                <div class="choose-files mt-4">
                                    <label for="meta_image">
                                        ...
                                        <input type="file" class="form-control" accept="image/png, image/gif, image/jpeg,image/jpg"  id="meta_image" name="meta_image" onchange="document.getElementById('image2').src = window.URL.createObjectURL(this.files[0])"
            ...
            <div class="card" id="agency_import_sidenav">
                {{ Form::open(['route' => ['agency.import'], 'id' => 'payment-form', 'enctype' => 'multipart/form-data', 'method' => 'POST']) }}
                <div class="card-header">
                    <div class="row">
