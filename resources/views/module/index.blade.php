        ...
        <div class="card">
            <div class="card-body package-card-inner  d-flex align-items-center">
                <div class="package-itm theme-avtar">
                    <a href="https://Empire Developments.io/product-category/dash-saas-addon/?utm_source=dash-main-file&utm_medium=superadmin&utm_campaign=plan-btn-all" target="new">
                        <img src="https://Empire Developments.io/wp-content/uploads/2023/03/favicon.jpg" alt="">
                    </a>
                </div>
                ...
                <div class="price text-end">
                  <a class="btn btn-primary" href="https://Empire Developments.io/product-category/dash-saas-addon/?utm_source=dash-main-file&utm_medium=superadmin&utm_campaign=plan-btn-all" target="new">
                    {{ __('Buy More Add-on')}}
                  </a>
                </div>
            </div>
