...
@section('meta')
    <title>Welcome to Empire Recidence, an exquisite development by Empire Developments</title>
@endsection
            ...
            <section class="section novi-background bg-cover section-horace mt-2">
                ...
                <div class="swiper-container swiper-slider swiper-slider-1" data-loop="true" data-autoplay="1000"
                    ...
                    <div class="swiper-wrapper text-center">
                        @php
                            $slider_images = [
                                asset('assets/front_assets/img/projects/empire-residence.jpg'),
                                asset('assets/front_assets/img/projects/empire_residence/bed-1.jpg'),
                                asset('assets/front_assets/img/projects/empire_residence/pool.jpg'),
                                asset('assets/front_assets/img/projects/empire_residence/lounge.png'),
                                asset('assets/front_assets/img/projects/empire_residence/gym.png')
                            ];
                        @endphp
                            ...
                            <div class="col-sm-4 col-md-12 col-xl-11 wow fadeInLeft">
                                <article class="box-icon-classic" data-aos="fade-right" data-aos-once="false"
                                    ...
                                    <div class="box-icon-classic-text">
                                        Immerse yourself in a realm of unparalleled comfort and convenience at Empire Residency.
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-4 col-md-12 col-xl-11 wow fadeInLeft" data-wow-delay=".05s">
                                <article class="box-icon-classic" data-aos="fade-right" data-aos-once="false"
                                    ...
                                    <div class="box-icon-classic-header">
                                        ...
                                        <h6 class="box-icon-classic-title">
                                            <a href="#">Claim Your Dream at Empire Residency</a>
                                        </h6>
                                    </div>
                                    <div class="box-icon-classic-text">
                                        Easy Payment Plans Available! Elevate your lifestyle at Empire Residency without compromising financial ease.
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-4 col-md-12 col-xl-11 wow fadeInLeft" data-wow-delay=".1s">
                                <article class="box-icon-classic" data-aos="fade-right" data-aos-once="false"
                                    ...
                                    <div class="box-icon-classic-header">
                                        ...
                                        <h6 class="box-icon-classic-title">
                                            <a href="#">Pinnacle of Exquisite Living</a>
                                        </h6>
                                    </div>
                                    <div class="box-icon-classic-text">
                                        Unrivaled elegance, meticulous design, redefining sophisticated living. Immerse in splendor, a residence that sets a new standard for richness.
                                    </div>
                                </article>
                            </div>
                        </div>
                ...
                <div class="row row-30 row-md-40 justify-content-lg-between">
                    <div class="col-lg-5">
                        <h6 class="title-style-1 wow fadeInLeft" data-aos="fade-left" data-aos-once="false"
                            data-aos-delay="300">Empire Residency</h6>
                        ...
                        <div class="tab-content wow fadeInLeft" data-aos="fade-left" data-aos-once="false"
                            ...
                            <div class="tab-pane fade" id="tabs-1-2">
                                <h3 class="title-style-1">Embark on the Epitome of Sophistication</h3>
                                <p>As one of the city's most luxurious addresses, Empire Residency stands out with its modern aesthetic philosophy and distinctive architecture. Elevate your lifestyle with an incredible clubhouse that ensures your days are always exciting and never mundane.</p>

                            </div>
                            <div class="tab-pane fade" id="tabs-1-3">
                                <h3 class="title-style-1">Experience the Pinnacle of Exquisite Living</h3>
                                <p>Empire Residency is a realm of unrivaled elegance and sophistication, meticulously crafted to redefine the essence of sophisticated living. Immerse yourself in the splendor of a home that exceeds expectations, setting a new standard for richness.</p>
                            </div>
                        ...
                        <div class="inset-xl-left-35">
                            ...
                            <div class="project-creative wow blurIn" data-aos="fade-up" data-aos-once="false"
                                ...
                                <div class="project-creative-figure active" data-view-trigger="#tabs-1-1"><img
                                        src="{{ asset('assets/front_assets/img/projects/empire_residence/bed-1.jpg') }}"
                                        alt="" width="531" height="327" />
                                </div>
                                <div class="project-creative-figure" data-view-trigger="#tabs-1-2"><img
                                        src="{{ asset('assets/front_assets/img/projects/empire_residence/pool.jpg') }}"
                                        alt="" width="531" height="327" />
                                </div>
                                <div class="project-creative-figure" data-view-trigger="#tabs-1-3"><img
                                        src="{{ asset('assets/front_assets/img/projects/empire_residence/gym.png') }}"
                                        alt="" width="531" height="327" />
                                </div>
                ...
                <div class="owl-carousel owl-style-1" data-autoplay="false" data-items="1" data-margin="30"
                    ...
                    <article class="project-mary" data-aos="fade-up" data-aos-once="false">
                        <div class="project-mary-figure"><img
                                src="{{asset('assets/front_assets/img/projects/empire_estates/floor_plans/studio.jpg')}}"
                            ...
                            <div class="project-mary-link-wrap"><a class="project-mary-link mdi mdi-magnify"
                                    ...
                                    href="{{asset('assets/front_assets/img/projects/empire_estates/floor_plans/studio.jpg')}}"></a>
                            </div>
                        </div>
                    ...
                    <article class="project-mary">
                        <div class="project-mary-figure"><img
                                src="{{asset('assets/front_assets/img/projects/empire_estates/floor_plans/1_bhk_a.jpg')}}"
                                alt="" width="775" height="524" />
                            <div class="project-mary-link-wrap"><a class="project-mary-link mdi mdi-magnify"
                                    data-fancybox="floor-plan-gallery"
                                    href="{{asset('assets/front_assets/img/projects/empire_estates/floor_plans/1_bhk_a.jpg')}}"></a>
                            </div>
                        </div>
                        <div class="project-mary-content">
                            <ul class="project-mary-panel">
                    ...
                    <article class="project-mary">
                        <div class="project-mary-figure"><img
                                src="{{asset('assets/front_assets/img/projects/empire_estates/floor_plans/2_bhk_a.jpg')}}"
                                alt="" width="775" height="524" />
                            <div class="project-mary-link-wrap"><a class="project-mary-link mdi mdi-magnify"
                                    data-fancybox="floor-plan-gallery"
                                    href="{{asset('assets/front_assets/img/projects/empire_estates/floor_plans/2_bhk_a.jpg')}}"></a>
                            </div>
                        </div>
                        <div class="project-mary-content">
                            <ul class="project-mary-panel">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-item d-flex">
                            <div class="icon flex-shrink-0"><img
                                    src="assets/img/icons/swim.svg" alt=""></div>
                            <div>
                                <h4 class="title">
