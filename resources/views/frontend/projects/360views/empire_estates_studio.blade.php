...
<head>
    <title>Studio - Empire Estate</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="user-scalable=no, initial-scale=0.5, width=device-width, viewport-fit=cover" />
    @php
        $assets_path = "assets/front_assets/360views/empire_estates/studio/";
    @endphp
    @include('frontend.includes.fav')

    <link rel="preload" href="{{ asset($assets_path.'script.js?v=1702927326378') }}" as="script" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_0.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_1.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_2.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_3.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_4.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_5.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_6.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_7.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_8.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_9.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_10.jpg?v=1702927326378') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_731E633D_7E5E_5A56_4188_11352C5BA817_0/2/0_11.jpg?v=1702927326378') }}"
        as="image" />
    ...
    <script src="{{ asset($assets_path.'lib/tdvplayer.js?v=1702927326378') }}"></script>
    <script type="text/javascript">
        ...
        function loadTour() {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, '{{ asset($assets_path.'script.js?v=1702927326378') }}');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, '{{ asset($assets_path.'lib/WebVRPolyfill.js?v=1702927326378') }}');
            settings.set(TDV.PlayerSettings.HLS_URL, '{{ asset($assets_path.'lib/Hls.js?v=1702927326378') }}');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1702927326378');
