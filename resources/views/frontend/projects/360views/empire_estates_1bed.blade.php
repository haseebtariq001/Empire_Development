...
<head>
    <title>1 Bed - Empire Estate</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="user-scalable=no, initial-scale=0.5, width=device-width, viewport-fit=cover" />
    @php
        $assets_path = "assets/front_assets/360views/empire_estates/1bed/";
    @endphp
    @include('frontend.includes.fav')
    
    <link rel="preload" href="{{ asset($assets_path.'script.js?v=1702408208878') }}" as="script" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_0.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_1.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_2.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_3.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_4.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_5.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_6.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_7.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_8.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_9.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_10.jpg?v=1702408208878') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_59607B46_55C2_B8D4_419F_46D10D06C83C_0/2/0_11.jpg?v=1702408208878') }}"
        as="image" />

    <meta name="description" content="Virtual Tour" />
    <meta name="theme-color" content="#FFFFFF" />
    <script src="{{ asset($assets_path.'lib/tdvplayer.js?v=1702408208878') }}"></script>
    <script type="text/javascript">
        ...
        function loadTour() {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, '{{ asset($assets_path.'script.js?v=1702408208878') }}');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, '{{ asset($assets_path.'lib/WebVRPolyfill.js?v=1702408208878') }}');
            settings.set(TDV.PlayerSettings.HLS_URL, '{{ asset($assets_path.'lib/Hls.js?v=1702408208878') }}');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1702408208878');
            ...
            player.bindOnObject('rootPlayer', 'start', function(e) {
                ...
                if (item != undefined && "trigger-overlay-name" in queryDict) {
                    triggerOverlayByName(item, queryDict["trigger-overlay-name"], "trigger-overlay-event" in
                        queryDict ? queryDict["trigger-overlay-event"] : "click");
                }
                    ...
                    var onResize = function(async) {
                        [0, 250, 1000, 2000].forEach(function(delay) {
                            setTimeout(function() {
                                ...
                                viewer.style.left = Math.round((window.innerWidth - width) * 0.5) +
                                'px';
                                viewer.style.top = Math.round((window.innerHeight - height) * 0.5) +
                                    'px';
