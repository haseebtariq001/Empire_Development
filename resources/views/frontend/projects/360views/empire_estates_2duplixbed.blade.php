...
<head>
    <title>2 BHK Duplex - Empire Estate</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="user-scalable=no, initial-scale=0.5, width=device-width, viewport-fit=cover" />
    @php
        $assets_path = "assets/front_assets/360views/empire_estates/2bedduplex/";
    @endphp
    @include('frontend.includes.fav')

    <link rel="preload" href="{{ asset($assets_path.'script.js?v=1702407907044') }}" as="script" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_0.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_1.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_2.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_3.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_4.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_5.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_6.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_7.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_8.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_9.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_10.jpg?v=1702407907044') }}"
        as="image" />
    <link rel="preload" href="{{ asset($assets_path.'media/panorama_5DE35DC5_508D_CD45_41C7_3A0C741C800C_0/2/0_11.jpg?v=1702407907044') }}"
        as="image" />

    <meta name="description" content="Virtual Tour" />
    <meta name="theme-color" content="#FFFFFF" />
    <script src="{{ asset($assets_path.'lib/tdvplayer.js?v=1702407907044') }}"></script>
    <script type="text/javascript">
        ...
        function loadTour() {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, '{{ asset($assets_path.'script.js?v=1702407907044') }}');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'lib/WebVRPolyfill.js?v=1702407907044');
            settings.set(TDV.PlayerSettings.HLS_URL, 'lib/Hls.js?v=1702407907044');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1702407907044');
