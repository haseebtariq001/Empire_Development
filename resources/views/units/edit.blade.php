{{ Form::model($unit, ['route' => ['project.unit.update', $unit->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-sm-12">
            ...
            {{ Form::text('selling_price', null, ['class' => 'form-control', 'required' => 'required']) }}
            @error('selling_price')
                <small class="invalid-name" role="alert">
                    <strong class="text-danger">{{ $message }}</strong>
                </small>
        ...
        <div class="form-group col-lg-6 col-sm-12">
            ...
            {{ Form::number('on_booking',  $unit->installmentPlan ? $unit->installmentPlan->down_payment : null, ['class' => 'form-control']) }}
            @error('on_booking')
                <small class="invalid-name" role="alert">
                    <strong class="text-danger">{{ $message }}</strong>
                </small>
        ...
        <div class="form-group col-lg-6 col-sm-12">
            ...
            {{ Form::number('on_completion', $unit->installmentPlan ? $unit->installmentPlan->completion_amount : null, ['class' => 'form-control']) }}
            @error('on_completion')
                <small class="invalid-name" role="alert">
                    <strong class="text-danger">{{ $message }}</strong>
                </small>
        ...
        <div class="form-group col-lg-6 col-sm-12">
            ...
            {{ Form::number('installment', $unit->installmentPlan ? $unit->installmentPlan->installment_amount : null, ['class' => 'form-control']) }}
            @error('installment')
                <small class="invalid-name" role="alert">
                    <strong class="text-danger">{{ $message }}</strong>
                </small>
        ...
        <div class="form-group col-lg-6 col-md-6 col-sm-12">
            {{ Form::label('image_file', __('Unit Plan'), ['class' => 'form-label']) }}<span
            ...
            <div class="choose-files">
                <label for="image" class="image-label">
                    ...
                    <img id="unit_preview" src="{{ get_file($unit->unit_plan) }}" class="hover-img" alt="your image"
                        width="187" height="160" />
                </label>
            </div>
        </div>

        <div class="form-group col-lg-6 col-md-6 col-sm-12">
            {{ Form::label('image_file', __('Key Plan'), ['class' => 'form-label']) }}<span
                class="text-danger">*</span>
            <div class="choose-files">
                <label for="key_image" class="image-label">
                    ...
                    <span class="hover-text">Upload Image</span>
                    <img id="key_preview" src="{{ get_file($unit->key_plan) }}" class="hover-img" alt="your image"
                        width="187" height="160" />
                </label>
            </div>
        </div>
        ...
        <div class="form-group col-12">
            ...
            {{ Form::select('status', ['' => __('Select Status'), 'Available' => 'Available', 'Reserved' => 'Reserved', 'Sold' => 'Sold'], $unit->status, ['class' => 'form-control', 'required' => 'required']) }}
