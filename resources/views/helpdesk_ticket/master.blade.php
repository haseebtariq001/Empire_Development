...
<head>
    ...
    <title>@yield('page-title') |
        {{ !empty(company_setting('title_text', $ticket->created_by)) ? company_setting('title_text', $ticket->created_by ) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'Empire Developments') }}
    </title>
