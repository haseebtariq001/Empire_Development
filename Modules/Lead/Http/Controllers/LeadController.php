...
class LeadController extends Controller
{
    ...
    public function create()
    {
        if (Auth::user()->can('lead create')) {
            ...
            return view('lead::leads.create', compact('users', 'customFields', 'projects'));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        if ($usr->can('lead create')) {
            ...
            if (empty($stage)) {
                ...
                $lead->unit_project_id    = $request->projects;
    ...
    public function edit(Lead $lead)
    {
        if (\Auth::user()->can('lead edit')) {
            if ($lead->created_by == creatorId()) {
                ...
                return view('lead::leads.edit', compact('lead', 'pipelines', 'sources', 'products', 'users', 'customFields', 'projects'));
            } else {
                return response()->json(['error' => __('Permission Denied.')], 401);
            }
        } else {
