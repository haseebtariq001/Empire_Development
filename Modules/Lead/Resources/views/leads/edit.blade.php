        ...
        @endif
            ...
            <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-6 form-group">
                        {{ Form::label('projects', __('Project'),['class'=>'col-form-label']) }}
                        {{ Form::select('projects', [''=>__('Select Project')] + $projects->pluck('name', 'id')->toArray(), $lead->unit_project_id, ['class' => 'form-control', 'required'=>'required']) }}
                    </div>
                    <div class="col-6 form-group">
