...
@section('page-action')
    <div>
        ...
        @can('lead to deal convert')
            @if (!empty($deal))
                <a href="@can('deal show') @if ($deal->is_active) {{ route('deals.show', $deal->id) }} @else # @endif @else # @endcan"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label for="task_{{ $task->id }}"
                                                                                    ...
                                                                                    <h6
                                                                                        ...
                                                                                        @if ($task->status)
                                                                                            <div
                                                                                                ...
                                                                                                {{ __(Modules\Lead\Entities\LeadTask::$status[$task->status]) }}
                                                                                            </div>
                                                                                        @else
                                                                                            <div
                                                                                    ...
                                                                                    <div class="text-xs text-muted">
                                                                                        {{ __(Modules\Lead\Entities\LeadTask::$priorities[$task->priority]) }}
                                                                                        -
                                                                                        <span
                            ...
                            @if (!Auth::user()->hasRole('client'))
                                <div class="col-md-6">
                                    <div class="card table-card deal-card">
                                        ...
                                        <div class="card-body p-0 table-border-style bg-none height-300"
                                            style ="overflow: auto;">
                                            <div class="">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span class="number-id">{{ $product->name }}
                                                                            ...
                                                                            class="text-muted">{{ currency_format_with_sym($product->price) }}</span>)
                                                                    </td>
                                                                    @can('lead edit')
                                                                        <td>
                                                                            <div class="action-btn bg-danger ms-2">
                            ...
                            <div class="col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="height:330px;">
                                        <textarea name="notes" class="tiny-mcu" id="summernote-simple">{!! $lead->notes !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
