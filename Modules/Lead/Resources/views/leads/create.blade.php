    ...
    <div class="tab-content tab-bordered">
        <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
            <div class="row">
                ...
                <div class="col-6 form-group">
                    {{ Form::label('Projects', __('Select Projects'), ['class' => 'col-form-label mt-3']) }}
                    {{ Form::select('projects', $projects->pluck('name', 'id'), null, ['class' => 'form-control']) }}
                </div>
                <div class="col-12 form-group">
                    {{ Form::label('comments', __('Notes'), ['class' => 'col-form-label']) }}
