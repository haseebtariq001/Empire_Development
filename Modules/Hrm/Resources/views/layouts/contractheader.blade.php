...
<head>
    <title>@yield('page-title') | {{ !empty(company_setting('title_text')) ? company_setting('title_text') : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'Empire Developments') }}</title>
