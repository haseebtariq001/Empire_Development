...
class User extends Authenticatable implements JWTSubject,MustVerifyEmail
{
    ...
    public function scopeSalesOfferUsers($query)
    {
        return $query->whereIn('type', $this->sales_offer_users);
    }
    public function scopeAgency($query)
    {
        return $query->whereIn('type', $this->agency_type);
    }
    ...
    public static function CompanySetting($id = null,$workspace_id = null)
    {
        if(!empty($id))
        {
            ...
            $company_setting = [
                ...
                "title_text" => !empty(admin_setting('title_text')) ? admin_setting('title_text') : "Empire Developments",
                "footer_text" => !empty(admin_setting('footer_text')) ? admin_setting('footer_text') :"Copyright © Empire Developments",
                "site_rtl" => "off",
                "cust_darklayout" => "on",
                "site_transparent" => "off",
                "color" => "theme-11",
                "invoice_prefix" => "#INVO",
                "sales_offer_prefix" => "#SALE-",
